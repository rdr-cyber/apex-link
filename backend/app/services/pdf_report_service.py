"""PDF report generation service for TRACE-NET."""
...
class PDFReportService:
    ...
    async def generate_pdf(self, case_id: uuid.UUID) -> bytes:
        ...
        # Header
        elements.append(Paragraph("TRACE-NET", title_style))
        ...
        elements.append(Spacer(1, 6))
        elements.append(Paragraph(
            f"TRACE-NET — Explainable Criminal Network &amp; Investigation Intelligence Platform<br/>"
            f"Generated by TRACE-NET v{report['algorithm_version']} | "
...
/F1 20 Tf
50 750 Td
(TRACE-NET Investigation Report) Tj
/F1 12 Tf
0 -30 Td
